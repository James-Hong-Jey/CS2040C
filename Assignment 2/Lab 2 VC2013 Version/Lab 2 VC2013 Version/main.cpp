...
void testEqual() {
	cout << "Testing operator \"==\" for class Food" << endl;

	Food food2("Penis", 200);
	Food food3("Penis", 2000);
	Food food4("Penis", 2000);
	Food food5("Painis", 200);
	...
	//cout << food2 == food4 ? "The numbers are wrong tho" : "Expected Behaviour" << endl;
	//cout << food2 == food5 ? "The name is wrong tho" : "Phew" << endl;
}
